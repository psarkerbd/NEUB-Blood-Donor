			...
			<tr style="text-align:center;height:25px;">
				...
				<?php } else {?>
					...
					?>
						...
						<td><a href="u_view.php?paging=<?php echo $_REQUEST['paging']; ?>&id=<?php echo $row['id']; ?>"> <button type="button" class="btn btn-primary btn-xs"> View </button> </a></td>
					<?php } else{ ?>
					<td><a href="u_view.php?id=<?php echo $row['id']; ?>"> <button type="button" class="btn btn-primary btn-xs"> View </button></a></td>
					<?php } ?>
			</tr>
