...
function test_input($data) {
  ...
  return $data;
        ...
        $sql="select * from user where nid='$_REQUEST[nid]' ";
		$res=mysql_query($sql);
	...
	?>
			...
			<center> <form action="a_donor.php" method="post" ENCTYPE="MULTIPART/FORM-DATA">
		<table>
			<input type="hidden" name="nid" value="<?php echo $_REQUEST['nid']; ?>">  
				<tr>
				<td><img src="images/users/<?php echo $arr['photo']; ?>" height="100" width="80" style="border:2px solid black;"></td>
			...
			<tr>
				<td></td>
				<td style="text-align:right;"><input type="submit" name="delete" value="Delete" style="border-radius:20px;background:gray;border:2px solid blue;color:white;width:60px;"></td>
			</tr>
